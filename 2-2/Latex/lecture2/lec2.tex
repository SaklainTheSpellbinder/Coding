...
$I^{(i)}_{4} \in \mathbb{S}_{4}$ 



$N = \frac{512 \times 512}{8 \times 8} = 4096$

$\mathbb{S} = \{I^{(i)} \in \mathbb{R}^{H \times W} , i \in [K] \}$

$((Q_1,K_1),(Q_2,K_2),\dots,(Q_L,K_L) )$

$\boldsymbol{A} =\{A_1, A_2, \dots , A_L\}$
