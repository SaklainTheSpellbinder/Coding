...
//    }
    ...
    private Order(Builder b) {
        this.orderId = requireNonBlank(b.orderId, "Order id");
        this.customerName = requireNonBlank(b.customerName, "Customer name");
        this.phone = requireNonBlank(b.phone, "Phone");
        this.deliveryType = (b.deliveryType!=null) ? b.deliveryType : DeliveryType.PICKUP;
        this.paymentMethod = (b.paymentMethod!=null) ? b.paymentMethod : PaymentMethod.CASH;
        this.scheduledTime = b.scheduledTime;
        this.couponCode = normalizeCoupon(b.couponCode);
        this.giftWrap = b.giftWrap;
        this.cutleryRequired = b.cutleryRequired;
        this.loyaltyPointsToRedeem = Math.max(0, b.loyaltyPointsToRedeem);
        this.rushOrder = b.rushOrder;
        this.specialInstructions = normalizeText(b.specialInstructions);
        this.items=copyOfItems(b.items);
        this.deliveryAddress=deliveryAddressResolve(b.deliveryType,b.deliveryAddress);
    }
    ...
    public static class Builder{
        ...
        public Builder deliveryType(DeliveryType v){
            this.deliveryType=v;
            return this;
        }

        public Builder deliveryAddress(String v){
        ...
        public Builder scheduledTime(LocalDateTime v){
        ...
        public Builder giftWrap(boolean v){
            this.giftWrap=v;
            return this;
        }

        public Builder cutleryRequired(boolean v){
            this.cutleryRequired=v;
            return this;
        }

        public Builder loyaltyPointsToRedeem(int v){
            this.loyaltyPointsToRedeem=v;
            return this;
        }

        public Builder rushOrder(boolean v){
            this.rushOrder=v;
            return this;
        }

        public Builder specialInstructions(String v){
    ...
    private static List<OrderItem> copyOfItems(List<OrderItem> items){
        Objects.requireNonNull(items, "Items cannot be null");
        if (items.isEmpty()) {
            throw new IllegalArgumentException("Order must contain at least one item");
        }
    ...
    private static String deliveryAddressResolve(DeliveryType type, String deliveryAddress){
        if (type == DeliveryType.DELIVERY) {
            return requireNonBlank(deliveryAddress, "Delivery address");
        } else {
            return normalizeText(deliveryAddress);
        }
    }
}
