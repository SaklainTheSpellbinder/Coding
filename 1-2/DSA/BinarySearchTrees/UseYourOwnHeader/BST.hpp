...
public:
    ...
    virtual Key LCA(Key, Key y)=0;

    virtual int height()=0;

    virtual void kthlevel(int k)=0;

    virtual int mindist(Key x,Key y)=0;

    virtual void findpath(Key x)=0;

    virtual Key getSuccessor(Key x)=0;

    virtual Key getPredecessor(Key x)=0;
